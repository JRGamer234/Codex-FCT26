...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forRoot(process.env.MONGO_URL || 'mongodb://localhost:27017/codex'),
            mongoose_1.MongooseModule.forFeature([{ name: 'Lesson', schema: lesson_schema_1.LessonSchema }]),
        ],
