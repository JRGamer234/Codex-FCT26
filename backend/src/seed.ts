...
const lessons = [
  {
    ...
    sections: [
      { title: '¿Qué es HTML?', content: 'HTML (HyperText Markup Language) es el lenguaje estándar para crear páginas web. Define la estructura y el contenido de una página mediante etiquetas.', code: '<!DOCTYPE html>\n<html>\n  <head>\n    <title>Mi primera página</title>\n  </head>\n  <body>\n    <h1>Hola Mundo</h1>\n  </body>\n</html>' },
      { title: 'Etiquetas básicas', content: 'Las etiquetas más comunes son los encabezados, párrafos, enlaces e imágenes.', code: '<h1>Encabezado</h1>\n<p>Párrafo</p>\n<a href="#">Enlace</a>\n<img src="foto.jpg" alt="Foto">' },
    ],
    questions: [
  ...
  },
  {
    ...
    sections: [
      { title: '¿Qué es Flexbox?', content: 'Flexbox es un modelo de layout unidimensional para distribuir elementos en filas o columnas.', code: '.container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}' },
      { title: '¿Qué es CSS Grid?', content: 'CSS Grid es un sistema bidimensional para crear layouts con filas y columnas.', code: '.container {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 1rem;\n}' },
    ],
    questions: [
  ...
  },
  {
    ...
    sections: [
      { title: 'Transiciones CSS', content: 'Las transiciones permiten cambiar valores de propiedades CSS de forma suave.', code: '.boton {\n  background: blue;\n  transition: background 0.3s ease;\n}\n.boton:hover {\n  background: red;\n}' },
      { title: 'Animaciones con @keyframes', content: 'Los keyframes definen los pasos intermedios de una animación CSS.', code: '@keyframes aparecer {\n  from { opacity: 0; }\n  to { opacity: 1; }\n}\n.elemento {\n  animation: aparecer 1s ease;\n}' },
    ],
    questions: [
  ...
  },
  {
    ...
    sections: [
      { title: 'Selectores de atributo', content: 'Los selectores de atributo permiten seleccionar elementos según sus atributos.', code: 'a[href] { color: blue; }\ninput[type="text"] { border: 1px solid gray; }' },
      { title: 'Pseudoclases', content: 'Las pseudoclases seleccionan elementos según su estado o posición.', code: 'a:hover { color: red; }\nli:first-child { font-weight: bold; }\ninput:focus { outline: 2px solid blue; }' },
    ],
    questions: [
  ...
  },
  {
    ...
    level: 'Inicial', category: 'HTML',
    sections: [
      { title: '¿Qué es un formulario?', content: 'Un formulario HTML permite recoger información del usuario mediante campos de texto, botones, checkboxes y más. Se define con la etiqueta form.', code: '<form action="/enviar" method="POST">\n  <input type="text" placeholder="Tu nombre">\n  <input type="email" placeholder="Tu email">\n  <button type="submit">Enviar</button>\n</form>' },
      { title: 'Tipos de input', content: 'El elemento input puede tener muchos tipos según el dato que queremos recoger.', code: '<input type="text">\n<input type="email">\n<input type="password">\n<input type="number">\n<input type="checkbox">\n<input type="radio">' },
    ],
    questions: [
  ...
  },
  {
    ...
    level: 'Intermedio', category: 'Layout',
    sections: [
      { title: 'Conceptos básicos de Flexbox', content: 'Flexbox organiza elementos en un eje principal. El contenedor flex distribuye el espacio entre sus hijos automáticamente.', code: '.container {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n}' },
      { title: 'Propiedades de los hijos', content: 'Los elementos hijos de un contenedor flex pueden controlarse individualmente con flex-grow, flex-shrink y flex-basis.', code: '.item {\n  flex: 1;\n  flex-grow: 1;\n  flex-shrink: 1;\n  flex-basis: 0%;\n}' },
    ],
    questions: [
      { question: '¿Qué propiedad activa Flexbox?', options: ['display: block', 'display: flex', 'display: grid', 'display: inline'], correct: 1 },
  ...
  },
  {
    ...
    sections: [
      { title: 'Conceptos básicos de Grid', content: 'CSS Grid permite crear layouts en dos dimensiones: filas y columnas. Es ideal para estructuras complejas de página.', code: '.container {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  grid-template-rows: auto;\n  gap: 1rem;\n}' },
      { title: 'Posicionamiento en Grid', content: 'Los elementos de un grid pueden ocupar múltiples columnas o filas usando grid-column y grid-row.', code: '.item-grande {\n  grid-column: 1 / 3;\n  grid-row: 1 / 2;\n}' },
    ],
    questions: [
      { question: '¿Qué propiedad activa CSS Grid?', options: ['display: flex', 'display: block', 'display: grid', 'display: table'], correct: 2 },
